...
export default ({message, visible, onConfirm, onCancel, showConfirm, showCancel, confirmText, cancelText, withInput, input, inputPlaceholder, setInput}) =>
  <div className={cx(styles.DialogWrapper, visible && styles.visible)}>
    <div className={cx(styles.Dialog)}>
      <div className={cx(styles.Content)}>
        ...
        {withInput && <TextInput value={input} setValue={setInput} className={styles.Input} placeholder={inputPlaceholder} />}
      </div>
