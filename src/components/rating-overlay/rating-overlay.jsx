...
export default ({className, visible, onRate, onClose}) =>
  <div className={cx(styles.RatingOverlay, !visible && styles.isHidden, className)}>
    <div className={styles.RatingContent}>
      ...
      <div className={styles.Buttons}>
        <ButtonWithText icon="back" label="RatingOverlayBack" onClick={() => onClose(true)}/>
        <ButtonWithText icon="call" label="RatingOverlayCall" onClick={() => onClose(false)}/>
      </div>
    </div>
  </div>
